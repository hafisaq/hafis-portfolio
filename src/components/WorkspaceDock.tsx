...
export function WorkspaceDock({ activeWorkspace, onSelectWorkspace }: WorkspaceDockProps) {
  ...
  return (
    <nav
      ...
      className="fixed inset-x-0 bottom-0 z-40 border-t border-stone-900/10 bg-[#f8f4eb]/88 px-2 pb-[max(0.5rem,env(safe-area-inset-bottom))] pt-2 shadow-2xl shadow-stone-950/10 backdrop-blur-xl transition-all duration-200 sm:bottom-5 sm:left-1/2 sm:right-auto sm:w-auto sm:-translate-x-1/2 sm:rounded-2xl sm:border sm:pb-2 sm:hover:px-3 sm:hover:py-3 dark:border-white/10 dark:bg-[#0d0c0b]/88 dark:shadow-black/30"
    >
